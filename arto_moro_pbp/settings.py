"""
Django settings for arto_moro_pbp project.
...
SECRET_KEY = 'django-insecure-v*syeixx(l9xfe6#^2xeac(2wv9b&3!-#xal@179+9q&m&anwm'
...
ROOT_URLCONF = 'arto_moro_pbp.urls'
...
WSGI_APPLICATION = 'arto_moro_pbp.wsgi.application'
